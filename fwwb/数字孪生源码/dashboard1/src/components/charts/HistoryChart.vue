...
onMounted(() => {
  ...
  chart.setOption({
    ...
    grid: { left: 50, right: 56, top: 36, bottom: '5%', containLabel: true },
    xAxis: {
      type: 'category', data: [],
    ...
    yAxis: [
      ...
      { type: 'value', name: 'ppm/ppb', min: 0, max: 1400, nameLocation: 'middle', nameGap: 42, nameRotate: -90, nameTextStyle: { color: '#64748b', fontSize: 12 }, axisLabel: { color: '#64748b', fontSize: 12 }, splitLine: { show: false } }
    ],
    series: [
