...
onMounted(() => {
  ...
  chart.setOption({
    ...
    legend: { data: ['温度(℃)', '湿度(%)', 'CO(ppm)', 'TVOC(ppb)', '危气(ppm)'], textStyle: { color: 'rgba(224,247,255,0.7)', fontSize: 12 }, top: 4, left: 'center' },
    ...
    yAxis: [
      { type: 'value', name: '℃/%', min: 0, max: 100, nameLocation: 'middle', nameGap: 36, nameRotate: 90, nameTextStyle: { color: 'rgba(224,247,255,0.7)', fontSize: 12 }, axisLabel: { color: 'rgba(224,247,255,0.7)', fontSize: 12 }, splitLine: { lineStyle: { color: 'rgba(49,171,227,0.25)' } } },
    ...
    series: [
      ...
      { name: '湿度(%)', type: 'line', smooth: true, symbol: 'none', lineStyle: { color: '#60a5fa' }, itemStyle: { color: '#60a5fa' }, data: [] },
