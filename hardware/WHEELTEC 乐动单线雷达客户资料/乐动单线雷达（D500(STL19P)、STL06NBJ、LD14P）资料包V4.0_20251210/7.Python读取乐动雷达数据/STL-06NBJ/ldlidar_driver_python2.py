...
if __name__ == '__main__':
        ...
        # ser = serial.Serial("COM5", 230400, timeout=5)    # window系统，需要先通过设备管理器确认COM口
        while True:
                 ...
                 if ord(data[0]) == 0x54 and ord(data[1]) == 0x2C:  # 判断是否为数据帧头
                    ...
                    listdata.insert(3, 360-(ord(data[41])*256+ord(data[40]))/100.0)  # 原始角度为方便传输放大了100倍，这里要除回去
                    ...
                    listdata.insert(30, 360-(ord(data[3])*256+ord(data[2]))/100.0)
