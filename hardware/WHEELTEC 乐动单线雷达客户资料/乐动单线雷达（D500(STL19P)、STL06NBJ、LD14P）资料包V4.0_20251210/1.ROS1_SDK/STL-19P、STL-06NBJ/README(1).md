...
②设备别名：端口设备重命名
launch中启动的雷达默认设备名为：/dev/wheeltec_lidar，别名文件是“ldlidar_udev.sh”，
...
roslaunch ldlidar stl06n.launch
启动：stl06nbj网口雷达
source devel/setup.bash
roslaunch ldlidar stl06nnet.launch
...
启动：stl19P网口雷达
source devel/setup.bash
roslaunch ldlidar ld06net.launch
